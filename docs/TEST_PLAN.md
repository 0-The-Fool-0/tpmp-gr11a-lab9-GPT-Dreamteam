...
- UI-тесты геолокации (ближайший офис) зависят от симулятора; основная логика покрыта unit-тестами.
...
| Роль | Задача |
|------|--------|
| Менеджер проекта | настройка GitHub Actions, Test Plan, порядок jobs |
| Разработчики | поддержка unit/UI-тестов, исправление падений CI |
